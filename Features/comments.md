...
7. A text-level comment whose anchored text has been deleted becomes orphaned and moves to the page-level section with a note.
8. @mention notifications fire once at the time of the mention — not again if the comment is edited.
